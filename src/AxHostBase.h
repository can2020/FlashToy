...
// copy from atlhost.h and modify it.

#include <atliface.h>
template <class ImplClass>
class CAxHostBase : 
	public CComCoClass<ImplClass, &CLSID_NULL>,
	public CComObjectRootEx<CComSingleThreadModel>,
	public CWindowImpl<ImplClass>,
	public IAxWinHostWindowLic,
	public IOleClientSite,
	public IOleInPlaceSiteWindowless,
	public IOleControlSite,
	public IOleContainer,
	public IObjectWithSiteImpl<ImplClass>,
...
public:
	...
	DECLARE_NO_REGISTRY()
	DECLARE_POLY_AGGREGATABLE(ImplClass)
	DECLARE_GET_CONTROLLING_UNKNOWN()

	BEGIN_COM_MAP(ImplClass)
...
// IObjectWithSite
	...
	{
		HRESULT hr = IObjectWithSiteImpl<ImplClass>::SetSite(pUnkSite);
...
// IOleInPlaceSiteWindowless
	...
	STDMETHOD(GetDC)(LPCRECT /*pRect*/, DWORD grfFlags, HDC* phDC)
	{
		...
		*phDC = CWindowImpl<ImplClass>::GetDC();
		if (*phDC == NULL)
			return E_FAIL;
	...
	{
		CWindowImpl<ImplClass>::InvalidateRect(pRect, fErase);
		return S_OK;
	}
	STDMETHOD(InvalidateRgn)(HRGN hRGN, BOOL fErase)
	{
		CWindowImpl<ImplClass>::InvalidateRgn(hRGN, fErase);
		return S_OK;
	}
...
// IOleControlSite
	...
	{
		ATLTRACENOTIMPL(_T("ImplClass::TransformCoords"));
	}
	...
	{
		ATLTRACENOTIMPL(_T("ImplClass::ShowPropertyFrame"));
	}
...
// IOleContainer
	...
	{
		ATLTRACENOTIMPL(_T("ImplClass::ParseDisplayName"));
	}
...
// state
	...
	{
		m_bSubclassed = CWindowImpl<ImplClass>::SubclassWindow(hWnd);
	}
